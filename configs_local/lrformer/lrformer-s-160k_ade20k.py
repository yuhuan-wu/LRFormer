_base_ = ['../_base_/datasets/ade20k.py', '../_base_/default_runtime.py', '../_base_/schedules/schedule_160k.py'
]
...
test_pipeline = [
    ...
    dict(type='AlignResize', scale=(2048, 512), size_divisor=32, keep_ratio=True),
